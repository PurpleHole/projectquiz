...
questions = [
    ...
    "8. Как называется столица Польши?"

]

answers = [
    "Стартап", "Инвестор", "Инвестиция", "MVP", "Бизнес-план", "Конкуренты", "Прибыль","Варшава"
]
score=0
print(questions[0])
...
if score>5:
    print("Это отличный результат! Ты знаешь много о стартапах.")

elif score >3:
    print("Неплохой результат! Как здорово,что тебе предстоит узнать еще много о стартапах.")
